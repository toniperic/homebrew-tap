...
# BSD 2-Clause License - Copyright (c) 2009-present, Homebrew contributors
...
class GitHubPrivateRepositoryDownloadStrategy < CurlDownloadStrategy
  ...
  def validate_github_repository_access!
    ...
    message = <<~EOS
      ...
      Token may lack permission or formula URL may be incorrect.
    EOS
...
class GitHubPrivateRepositoryReleaseDownloadStrategy < GitHubPrivateRepositoryDownloadStrategy
  ...
  def fetch_release_metadata
    ...
    GitHub::API.open_rest(release_url, data: nil, data_binary_path: nil,
                         request_method: nil, scopes: [].freeze, parse_json: true)
  end
end
